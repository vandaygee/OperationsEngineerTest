...
class Policy(db.Model):
    ...
    status = db.Column(u'status', db.Enum(u'Active', u'Canceled', u'Expired', u'Cancellation pending due to non-pay'),
    ...
    cancellation_reason = db.Column(u'cancellation_reason', db.VARCHAR(length=128), nullable=True)
